...
<div class="container mx-auto p-4">
    <form action="{{ route('generate-pdf') }}" method="post" class="bg-white shadow-md rounded-lg p-6">
        ...
        <table class="w-full">
            <tbody>
                <tr>
                    <td class="fs-5 py-2">データベース１</td>
                    <td><input class="w-full py-2 px-4 border rounded-lg" type="text" maxlength="15" placeholder=""　value="{{$tweet->tweet}}"></td>
                </tr>
                <tr>
                    <td class="fs-5 py-2">データベース２</td>
                    <td><input class="w-full py-2 px-4 border rounded-lg" type="text" maxlength="15"  placeholder="{{$tweet->description}}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <p class="w-full py-2 px-4 border rounded-lg" type="text" name="db_tweet" value="{{$tweet->tweet}}">{{$tweet->tweet}}</p>
                    </td>
                </tr>
                <tr>
                    <td class="fs-5 py-2">文章</td>
                    <td>
                        <p class="w-full py-2 px-4 border rounded-lg" type="text" name="db_description" value="">{{$tweet->description}}</p>
                </tr>
                <tr>
                 ...
                 <input class="w-full py-2 px-4 border rounded-lg" type="hidden" name="db_tweet" value="{{$tweet->tweet}}">
                 <input class="w-full py-2 px-4 border rounded-lg" type="hidden" name="db_description" value="{{$tweet->description}}">
